...
![Store Opening](assets/1storestart.png?raw=true "Store Opening")

The user is then asked how many of the item the user would like to purchase

![Quantity](assets/2quantconf.png?raw=true "Quantity")
...
![Purchase Confirm](assets/3purchase.png?raw=true "Purchase Confirm")
...
![Connection End](assets/4end.png?raw=true "Connection End")
